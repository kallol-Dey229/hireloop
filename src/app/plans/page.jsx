...
import { Check, CircleQuestion, ChevronDown, Person, Briefcase, Rocket, Star } from '@gravity-ui/icons';
                ...
                <div className="flex justify-center mb-16">
                    <div className="p-1.5 bg-zinc-900 border border-zinc-800 rounded-xl flex items-center gap-1 shadow-inner">
                        <button
                            ...
                            className={`cursor-pointer flex items-center gap-2 px-5 py-2 text-sm font-medium rounded-lg transition-all duration-200 ${billingTarget === 'seeker'
                        ...
                        <button
                            ...
                            className={`cursor-pointer flex items-center gap-2 px-5 py-2 text-sm font-medium rounded-lg transition-all duration-200 ${billingTarget === 'recruiter'
                                ? 'bg-zinc-800 text-white shadow-md border border-zinc-700/50'
                                : 'text-zinc-400 hover:text-zinc-200'
                                }`}
                        >
                                ...
                                <form action="/api/checkout_sessions" method="POST">
                                    ...
                                    <section>
                                        <button type="submit" role="link"
                                            className={`cursor-pointer block w-full text-center text-xs font-semibold px-4 py-3 rounded-xl transition duration-200 ${plan.popular
